	...
	public static void main(String[] args){
     ...
     //   Audience a = context.getBean(Audience.class);
      ...
      //  a.performance();
	    ...
	    ClassPathXmlApplicationContext context2 = new ClassPathXmlApplicationContext(configXmlPath.toString());
		
	    SingPreformance p =  (SingPreformance) context2.getBean("singPerformance");
        p.perform();
	}
}
